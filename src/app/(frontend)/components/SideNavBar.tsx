    ...
    return (
      ...
      <div className="p-6 border-b-2 border-pink-200 overflow-hidden flex items-center justify-center h-40">
        <div className="relative flex items-center justify-center w-full h-full">
          ...
          <p className="text-xl font-bold text-pink-600 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-300 opacity-0 group-hover:opacity-100 whitespace-nowrap">
            JAC @ UCLA
          </p>
        </div>
      </div>
