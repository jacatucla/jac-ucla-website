      ...
      <div className={`fixed h-screen top-0 left-0 group bg-gradient-to-b from-pink-50 to-purple-50 border-r-4 border-pink-200 flex flex-col transition-all duration-300 ease-in-out z-20
        ...
        <div className="p-6 border-b-2 border-pink-200 overflow-hidden flex items-center justify-center h-40">
          <div className="relative flex items-center justify-center w-full h-full">
            {/* Vertical JAC (visible when collapsed on desktop) */}
            <div className="hidden md:flex flex-col items-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-0 opacity-100 group-hover:opacity-0">
            ...
            {/* Horizontal JAC @ UCLA (visible when expanded or on mobile) */}
            <p className="text-xl font-bold text-pink-600 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-opacity duration-300 whitespace-nowrap
              ...
              return (
                <li key={link.name}>
                  ...
                  >
                    ...
                    <span className="md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 opacity-100">
                      {link.name}
                    </span>
                  </a>
                </li>
        ...
        <div className="p-4 border-t-2 border-pink-200 h-44">
          <div className="flex flex-row md:flex-col md:group-hover:flex-row gap-4 items-center justify-center h-full">
            <a
